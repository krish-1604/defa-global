        ...
        <div className="relative z-20 px-4 sm:px-6 md:px-8 lg:px-[3%] py-16 md:py-20 lg:py-[12.5%] w-full md:max-w-[80%] lg:max-w-[70%] xl:max-w-[60%]">
          ...
          <div className="w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[70%] pb-8 md:pb-12 lg:pb-16">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed md:leading-loose font-hk text-white drop-shadow-md">
              ...
              offering integrated solutions across industrial supply, mechanical
              systems, building materials, and engineering consultancy. Since
              our inception in 2025, we have built a strong reputation for
              reliability, technical proficiency, and customer-first service.
              Our clients span the industrial, infrastructure, and oil & gas
              sectors. We are also proud of our established presence in Oman
              since 2011 through our sister concerns, extending our reach and
              service capabilities across the region.
            </p>
          </div>
        </div>
      </section>
